document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const getErrorMessage = function (field) {
      ...
      if (field.validity.typeMismatch || (type === 'email' && !validators.email(field.value))) {
        return 'Please enter a valid email address.';
      }
      if (field.validity.tooShort || field.dataset.minlength) {
        const min = field.minLength > 0 ? field.minLength : field.dataset.minlength;
    ...
    const validateField = function (field) {
      ...
      } else if (field.dataset.minlength && field.value.trim() !== '') {
        if (!validators.minlength(field.value, field.dataset.minlength)) {
          isValid = false;
          errorMessage = getErrorMessage(field);
        }
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בית הספר חמ\"ד תורני לבי\"א, חריש משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7858b39a-eaae-4a57-8e5e-7813a3dd60e5',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7858b39a-eaae-4a57-8e5e-7813a3dd60e5';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7858b39a-eaae-4a57-8e5e-7813a3dd60e5';
